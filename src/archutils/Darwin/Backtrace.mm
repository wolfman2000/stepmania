...
static bool GetRegionInfo( vm_map_t self, const void *address, vm_address_t &startOut, vm_prot_t &protectionOut )
{
  vm_region_basic_info_data_64_t info;
  mach_msg_type_number_t infoCnt = VM_REGION_BASIC_INFO_COUNT_64;
  mach_port_t unused;
  mach_vm_size_t size = 0;
  mach_vm_address_t start = vm_address_t( address );
  kern_return_t ret = mach_vm_region( self, &start, &size, VM_REGION_BASIC_INFO_64,
